...
from cosyvoice.utils.runtime_paths import setup_runtime_paths, wrap_snapshot_download
...
snapshot_download = wrap_snapshot_download(modelscope_snapshot_download)
